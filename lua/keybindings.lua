...
-- 左右比例控制
map("n", "<leader>w<Left>", ":vertical resize -10<CR>", opt)
map("n", "<leader>w<Right>", ":vertical resize +10<CR>", opt)
...
-- map("n", "<C-H>", ":tabp<CR>", opt)
-- map("n", "<C-L>", ":tabn<CR>", opt)
